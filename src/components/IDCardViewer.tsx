...
export default function IDCardViewer({ trigger }: { trigger?: "card" | "row" }) {
  ...
  const buttonClass =
    trigger === "row"
      ? "flex items-center justify-between rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-900 dark:hover:bg-gray-800"
...
function IdIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden>
      ...
      <path d="M4.5 13c.5-1.5 1.8-2 2.5-2s2 .5 2.5 2M11.5 8h4M11.5 11h4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  );
}
